...
function DepletionSimulator() {
  const params = useSearchParams();
  const raw = params.get("startAssets");
  const preset = raw ? { startAssets: Number(raw) } : undefined;
        ...
        <>
          <NumberField
            ...
            onChange={(v) => {
              ...
              setInput({ ...input, startAge: age, horizonYears: Math.max(1, 100 - age) });
            }}
            min={20}
            max={120}
          />
