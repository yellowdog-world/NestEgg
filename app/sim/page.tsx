...
export default function SimIndexPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <header>
        <h1 className="text-3xl font-bold tracking-tight">시뮬레이터</h1>
      ...
      {Object.entries(grouped).map(([group, items]) => (
        <section key={group}>
          <h2 className="mb-3 text-base font-medium tracking-wide text-neutral-600 uppercase">
            {group}
          </h2>
            ...
            {items.map((s) => (
              <li key={s.path}>
                ...
                >
                  ...
                  <div className="mt-0.5 text-base text-neutral-600">{s.description}</div>
                </Link>
              </li>
            ))}
          </ul>
